	...
	var ms = {
		...
		fillHtml: function(obj, args) {
			return(function() {
				...
				//上一页
				if(args.current > 1) {
          obj.append('<a class="homePage icon fa-angle-double-left"><b> </b></a>');
					obj.append('<a href="javascript:;" class="prevPage icon fa-angle-left"><b></b> </a>');
				} else {
					obj.remove('.prevPage');
          obj.remove('.homePage');
          obj.append('<a class="disabled icon fa-angle-double-left"><b> </b></a>');
					obj.append('<a class="disabled icon fa-angle-left"><b></b></a>');
				}
				//中间页码
				...
				if(args.current < args.pageCount) {
					obj.append('<a href="javascript:void(0);" class="nextPage icon fa-angle-right"><b></b></a>');
          obj.append('<a class="endPage icon fa-angle-double-right"><b></b></a>');
				} else {
					obj.remove('.nextPage');
					obj.remove('.endPage');
					obj.append('<a class="disabled icon fa-angle-right"><b></b></a>');
          obj.append('<a class="disabled icon fa-angle-double-right"><b></b></a>');
				}
